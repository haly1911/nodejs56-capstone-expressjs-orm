...
imageRouter.post("/", protect, handleUpload(uploadMemory.single("image")), imageController.createImage);
imageRouter.put("/:imageId", protect, handleUpload(uploadMemory.single("image")), imageController.updateImage);
